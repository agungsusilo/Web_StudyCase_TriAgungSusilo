...
public class WebDriverInstance {
  ...
  public static void initialize() {
    ...
    options
        .addArguments("--start-maximized", "--disable-infobars"); // Add some options

    options.setCapability(CapabilityType.PLATFORM_NAME, Platform.WINDOWS); // Optional, only as an info
